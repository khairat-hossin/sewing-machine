...
<div class="col-md-8 offset-md-2">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.setup.process.update') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <div class="form-group {{ $errors->has('process_id') ? 'has-error' : '' }}">
                    <label for="process_id">Process ID*</label>
                    <input type="hidden" name="id" value="{{ $process->id }}">
                    <input type="text" id="process_id" name="process_id" class="form-control" value="{{ $process->process_id }}" required>
                ...
                <div class="form-group {{ $errors->has('process_name') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="process_name" name="process_name" class="form-control" value="{{ $process->process_name }}" required>
