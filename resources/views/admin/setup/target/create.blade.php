...
<div class="col-md-8 offset-md-2">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.setup.target.store') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <div class="form-group {{ $errors->has('target_date') ? 'has-error' : '' }}">
                    <label for="target_date">Target From*</label>
                    <input type="date" id="target_date" name="target_date" class="form-control" value="{{ old('target_date') }}" placeholder="Enter Target Value" required>
                ...
                <div class="form-group {{ $errors->has('target_date_end') ? 'has-error' : '' }}">
                    ...
                    <input type="date" id="target_date_end" name="target_date_end" class="form-control" value="{{ old('target_date_end') }}" placeholder="Enter Target Value" required>
                ...
                <div class="form-group {{ $errors->has('target_value') ? 'has-error' : '' }}">
                    ...
                    <input type="number" id="target_value" name="target_value" class="form-control" value="{{ old('target_value') }}" placeholder="Enter Target Value" required>
