...
<div class="col-md-8 offset-md-2">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.setup.item.store') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <div class="form-group {{ $errors->has('item_code') ? 'has-error' : '' }}">
                    <label for="item_code">Item Code*</label>
                    <input type="text" id="item_code" name="item_code" class="form-control" value="{{ old('item_code') }}" required>
