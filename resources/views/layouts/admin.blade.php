...
<head>
    ...
    <title>LOGIKEYE | Induatrial Network System</title>
...
<body class="sidebar-mini" style="height: auto;">
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand bg-info navbar-light border-bottom" >
            ...
            <ul class="navbar-nav">
                ...
                <h3><strong>LOGIKEYE</strong> Induatrial Network System</h3>
            </ul>
        ...
        <footer class="main-footer">
            <div class="float-right d-none d-sm-block">
                <b>LOGIKEYE</b> Induatrial Network System
            </div>
    ...
    {{-- High Chart Start --}}
    <script src="{{ asset('js/highchart/js/highcharts.js') }}"></script>
    <script src="{{ asset('js/highchart/js/exporting.js') }}"></script>
    <script src="{{ asset('js/highchart/js/export-data.js') }}"></script>
    <script src="{{ asset('js/highchart/js/accessibility.js') }}"></script>
    {{-- .High Chart End --}}
